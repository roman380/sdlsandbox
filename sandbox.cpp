...
int main(int argc, char** argv)
{
	...
	const uint32_t windowFlags = SDL_WINDOW_OPENGL | SDL_WINDOW_ALLOW_HIGHDPI;
	SDL_Window* Window = SDL_CreateWindow("Test", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, displayMode.w * 0.66, displayMode.h * 0.66, windowFlags);
